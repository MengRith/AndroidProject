package kh.com.mereanandroidyoutube.basictoadvance.feature.screendatepicker
    ...
    Scaffold(
        ...
        Column(
            ...
            state.selectedDateMillis?.let { millis ->
                Text("Selected date: ${formatMillis(millis, "yyyy-MM-dd")}")
            }
            ...
            state.selectedDateMillis?.let { millis ->
                Text("Selected date: ${formatMillis(millis, "MM/dd/yyyy")}")
            }
            Spacer(Modifier.height(16.dp))
            HorizontalDivider()
            Spacer(Modifier.height(16.dp))
            ...
            state.selectedDateMillis?.let { millis ->
                Text("Selected date: ${formatMillis(millis, "MMMM dd, yyyy")}")
            }
        }
        ...
        if (isShowDatePicker) {
            DatePickerDialog(
                ...
                dismissButton = {
                    FilledTonalButton(
                        onClick = { isShowDatePicker = false }
                    ) { Text("Cancel") }
                },
                confirmButton = {
                    TextButton(
